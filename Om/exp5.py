#Cryptographic Hash Functions and Applications (HMAC): to understand the need, design  and applications of collision resistant hash functions. 
...
# Enter a slightly modified message: hellp
